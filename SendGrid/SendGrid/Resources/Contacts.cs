...
namespace SendGrid.Resources
{
    public class Contacts
    {
        ...
        {
            return await SearchAsync(fieldName, value.ToUnixTime().ToString(CultureInfo.InvariantCulture), cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await SearchAsync(fieldName, value.ToString(CultureInfo.InvariantCulture), cancellationToken).ConfigureAwait(false);
        }
