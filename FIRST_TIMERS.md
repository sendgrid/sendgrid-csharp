...
2. __[Fork](https://help.github.com/fork-a-repo/)__ the [sendgrid-csharp](https://github.com/sendgrid/sendgrid-csharp) repository:
...
git clone https://github.com/your_username/sendgrid-csharp
