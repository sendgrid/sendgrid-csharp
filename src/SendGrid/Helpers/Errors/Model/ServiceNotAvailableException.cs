...
namespace SendGrid.Helpers.Errors.Model
{
    ...
    public class ServiceNotAvailableException : SendGridInternalException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceNotAvailableException"/> class with a specified error.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceNotAvailableException"/> class with a specified error and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
