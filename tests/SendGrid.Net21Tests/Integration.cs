namespace SendGrid.Tests
{
    ...
    {
        private const string SkipConfigureApiKey = "API key must be configured"; // change to null after configuring API key
  ...
  'username': 'jane@example.com'
        ...
        /// </summary>
        /// <returns></returns>
        [Theory(Skip = SkipConfigureApiKey)]
        [InlineData("$id")]
        [InlineData("$ref")]
